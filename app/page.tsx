        ...
        <section className="text-center mb-12 sm:mb-16">
          ...
          <div className="max-w-xl mx-auto relative z-30" ref={dropdownRef}>
            ...
            {showSuggestions && suggestions.length > 0 && (
              <div className="absolute left-0 right-0 mt-2 glass rounded-2xl border border-accent/20 bg-[#1F0F0D]/95 backdrop-blur-xl max-h-60 overflow-y-auto custom-scrollbar shadow-[0_10px_40px_rgba(0,0,0,0.6)] text-left transition-all duration-200">
